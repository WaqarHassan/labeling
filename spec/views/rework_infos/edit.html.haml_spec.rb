...
RSpec.describe "rework_infos/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit rework_info form" do
    render

    assert_select "form[action=?][method=?]", rework_info_path(@rework_info), "post" do
