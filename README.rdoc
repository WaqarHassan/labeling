...
Modify config/locales/en.yml. Replace references to Labeling.

Modify config/application.rb. Replace references to Labeling.
...
Labeling is pre-configured to make it easy to deploy apps into production environments.
...
* setup Errbit or Airbrake and configure Labeling to track errors
