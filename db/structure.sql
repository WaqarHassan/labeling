...
--
-- Host: 127.0.0.1    Database: labeling_dev
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=2714 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1245 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `new_reason_codes`
--

DROP TABLE IF EXISTS `new_reason_codes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `new_reason_codes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `work_flow_id` int(11) DEFAULT NULL,
  `recording_level` varchar(255) DEFAULT NULL,
  `object` varchar(255) DEFAULT NULL,
  `reason_code` varchar(255) DEFAULT NULL,
  `parent_id` int(11) DEFAULT NULL,
  `child_mandatory` tinyint(1) DEFAULT NULL,
...
--
-- Table structure for table `reason_code_value_archives`
--

DROP TABLE IF EXISTS `reason_code_value_archives`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `reason_code_value_archives` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `object_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `reason_code_values`
--

DROP TABLE IF EXISTS `reason_code_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `reason_code_values` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `object_id` int(11) DEFAULT NULL,
  `object_type` varchar(255) DEFAULT NULL,
  `new_reason_code_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `reason_code_values_archives`
--

DROP TABLE IF EXISTS `reason_code_values_archives`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `reason_code_values_archives` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `object_id` int(11) DEFAULT NULL,
  `object_type` varchar(255) DEFAULT NULL,
  `new_reason_code_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `timestamp_log_archives`
--

DROP TABLE IF EXISTS `timestamp_log_archives`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `timestamp_log_archives` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18565 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `timestamp_logs` (
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18581 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `work_flows` (
  ...
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `day_capacity` int(11) DEFAULT '15',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=23998 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO schema_migrations (version) VALUES ('20161024055239');

INSERT INTO schema_migrations (version) VALUES ('20161026061943');

INSERT INTO schema_migrations (version) VALUES ('20161026121246');

INSERT INTO schema_migrations (version) VALUES ('20161028060049');

INSERT INTO schema_migrations (version) VALUES ('20161028060310');

INSERT INTO schema_migrations (version) VALUES ('20161103042800');

INSERT INTO schema_migrations (version) VALUES ('20161116050200');
